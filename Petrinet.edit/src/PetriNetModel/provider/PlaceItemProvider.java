...
/**
 * This is the item provider adapter for a {@link PetriNetModel.Place} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlaceItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PetriNetModelPackage.Literals.PLACE__TOKENS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Place.class)) {
			case PetriNetModelPackage.PLACE__TOKENS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PetriNetModelPackage.Literals.PLACE__TOKENS,
				 PetriNetModelFactory.eINSTANCE.createToken()));
	}
